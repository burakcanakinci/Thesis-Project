<template>
    <div class="section services-section wf-section">
            <div class="container-default w-container">
              ...
              <div class="services-main-wrapper">
                ...
                <div class="bg services-square"></div>
              </div>
              <div
                data-w-id="44188954-e756-82a1-5142-83eec3745ca0"
                style="
                  transform: translate3d(0px, 0px, 0px) scale3d(0.97, 0.97, 1)
                    rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg);
                  opacity: 0;
                  transform-style: preserve-3d;
                "
